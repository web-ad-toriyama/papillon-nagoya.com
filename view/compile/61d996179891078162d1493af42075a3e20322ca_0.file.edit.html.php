<?php /* Smarty version 3.1.22-dev/9, created on 2023-12-01 19:05:53
         compiled from "/home/kir330489/public_html/papillon-nagoya.com/view/admin/event/edit.html" */ ?>
<?php
/*%%SmartyHeaderCode:14413833426569b0013d0a09_77849472%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '61d996179891078162d1493af42075a3e20322ca' => 
    array (
      0 => '/home/kir330489/public_html/papillon-nagoya.com/view/admin/event/edit.html',
      1 => 1680160206,
      2 => 'file',
    ),
    ...
    '93cfda6382b0caf9c18fa909b3dbd5e9758edd6e' => 
    array (
      0 => '93cfda6382b0caf9c18fa909b3dbd5e9758edd6e',
      1 => 0,
      2 => 'string',
    ),
    '6cf194fad67b65434359bde0a3ed1c4d5d47f7a1' => 
    array (
      0 => '6cf194fad67b65434359bde0a3ed1c4d5d47f7a1',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '14413833426569b0013d0a09_77849472',
  'tpl_function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6569b0015c7262_81683093',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_6569b0015c7262_81683093')) {
function content_6569b0015c7262_81683093 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '14413833426569b0013d0a09_77849472';
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
<div class="form-panel">
    <form class="form-horizontal style-form" action="finish.php" method="post"
...
">
    <div class="form-group">
        <label class="col-sm-2 control-label">イベント画像</label>
...
(px)サイズ</span>で作成されます。</span><br>
                <?php if ($_smarty_tpl->tpl_vars['data']->value['file_name']!='') {?>
...
">
            ...
            <p>
                <input type="button" class="btn btn-primary" onclick="return uploadFile(this.name,'');" name="event" value="アップロード">
                <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['file_name'];?>
" id="event_f_name" name="event">
                <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['file_name'];?>
" name="event_old">
            </p>
        </div>
...
<?php echo '<script'; ?>
 src="<?php echo @constant('AD_URL');?>
/js/check/event.js"><?php echo '</script'; ?>
>
<!-- /content-panel -->
