<?php /* Smarty version 3.1.22-dev/9, created on 2023-11-18 19:21:31
         compiled from "/home/kir330489/public_html/papillon-nagoya.com/view/admin/enquete/edit.html" */ ?>
<?php
/*%%SmartyHeaderCode:18653271816558902b4b9928_27398380%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0607ef33757344f745d79046a757f7d157f3f16e' => 
    array (
      0 => '/home/kir330489/public_html/papillon-nagoya.com/view/admin/enquete/edit.html',
      1 => 1680160206,
      2 => 'file',
    ),
    ...
    '085f4c54241ea1c657e794873bec16f6cbaf0b78' => 
    array (
      0 => '085f4c54241ea1c657e794873bec16f6cbaf0b78',
      1 => 0,
      2 => 'string',
    ),
    '6ce05ec43966d6d2b651ce4f721b8371ffcf6069' => 
    array (
      0 => '6ce05ec43966d6d2b651ce4f721b8371ffcf6069',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '18653271816558902b4b9928_27398380',
  'tpl_function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6558902b5e9d31_39273373',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_6558902b5e9d31_39273373')) {
function content_6558902b5e9d31_39273373 ($_smarty_tpl) {
...
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '18653271816558902b4b9928_27398380';
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">ご利用日</label>
            <div class="col-sm-10">
                <?php echo $_smarty_tpl->tpl_vars['data']->value['use_year'];?>
年
                <?php echo $_smarty_tpl->tpl_vars['data']->value['use_month'];?>
月
                <?php echo $_smarty_tpl->tpl_vars['data']->value['use_day'];?>
日
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['name'])===null||$tmp==='' ? '' : $tmp);?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['phone'])===null||$tmp==='' ? '' : $tmp);?>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">担当セラピスト</label>
            <div class="col-sm-10">
                <?php echo $_smarty_tpl->tpl_vars['staff_list']->value[$_smarty_tpl->tpl_vars['data']->value['staff_id']];?>

            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">ルックス</label>
            <div class="col-sm-10">
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['looks'])===null||$tmp==='' ? '' : $tmp);?>

            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">接客態度</label>
            <div class="col-sm-10">
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['service'])===null||$tmp==='' ? '' : $tmp);?>

            </div>
        </div>        
        <div class="form-group">
            <label class="col-sm-2 control-label">マッサージ</label>
            <div class="col-sm-10">
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['massage'])===null||$tmp==='' ? '' : $tmp);?>

            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">総合満足度</label>
            <div class="col-sm-10">
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['total'])===null||$tmp==='' ? '' : $tmp);?>

            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">スタッフの電話対応</label>
            <div class="col-sm-10">
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['staff_phone'])===null||$tmp==='' ? '' : $tmp);?>

            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">ルームの清潔度</label>
            <div class="col-sm-10">
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['room'])===null||$tmp==='' ? '' : $tmp);?>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">今までで一番良かった<?php echo @constant('STAFF_CALL');?>
</span>
            </label>

            <div class="col-sm-10">
                <?php if ($_smarty_tpl->tpl_vars['data']->value['best_staff_id']) {
echo $_smarty_tpl->tpl_vars['staff_list']->value[$_smarty_tpl->tpl_vars['data']->value['staff_id']];?>
<br><?php }?>
                <?php echo nl2br($_smarty_tpl->tpl_vars['data']->value['staff_comment']);?>

            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">お店、セラピストへのご意見ご要望、メッセージなど</span>
            </label>

            <div class="col-sm-10">
                <?php echo nl2br($_smarty_tpl->tpl_vars['data']->value['comment']);?>
